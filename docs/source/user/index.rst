...
The simplest way to install Dungeon Nexus is using Pip.

.. code-block:: console

    $ pip install dungeon_nexus

This will install ``dungeon_nexus`` and all of its dependencies.
...
The `API Reference <http://dungeon_nexus.readthedocs.io>`_ provides API-level documentation.
...
Report bugs at the `issue tracker <https://github.com/boltronics/dungeon_nexus/issues>`_.
